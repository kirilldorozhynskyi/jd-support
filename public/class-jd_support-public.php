...
class Jd_support_Public
{
	...
	public function enqueue_styles()
	{
		...
		wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . 'css/jd_support-public.css', [], $this->version, 'all');
	}
}
